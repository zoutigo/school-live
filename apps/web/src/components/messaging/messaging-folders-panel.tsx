...
export function MessagingFoldersPanel({
  ...
  return (
    <aside className="flex h-full min-h-0 flex-col rounded-[20px] border border-warm-border bg-[linear-gradient(180deg,rgba(255,253,252,1)_0%,rgba(255,248,240,0.94)_100%)] p-2 shadow-[0_14px_30px_rgba(77,56,32,0.07)]">
          ...
          {folders.map((item) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 rounded-[16px] px-3 py-2 text-sm text-left transition ${
                  active
      ...
      {showComposeButton ? (
        <button
          type="button"
          onClick={onCompose}
          className="mt-2 inline-flex w-full items-center justify-center gap-2 rounded-[16px] bg-primary px-3 py-2.5 text-sm font-semibold text-white shadow-[0_12px_24px_rgba(12,95,168,0.18)] transition hover:bg-primary-dark"
        >
