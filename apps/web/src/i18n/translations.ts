...
export const translations: Record<Locale, Record<string, string>> = {
  fr: {
    ...
    "header.role.schoolHealthOfficer": "Responsable sante",
    ...
    "tests.help.section1Title": "Synthèse",
    "tests.help.section1Body":
      "Cet onglet donne une vue d'ensemble : nombre de campagnes, campagnes en cours/à venir/terminées, nombre total de cas de test et de tests restants. La carte « À faire aujourd'hui » met en avant la campagne la plus urgente (échéance la plus proche) qu'il vous reste à terminer, avec un bouton pour la démarrer directement. Cliquer une carte de statistique (Campagnes, En cours, etc.) ouvre directement l'onglet Campagnes filtré sur ce statut.",
    "tests.help.section2Title": "Campagnes",
    "tests.help.section2Body":
      "Une campagne regroupe plusieurs cas de test à réaliser. Utilisez la barre de recherche pour retrouver une campagne par son titre ou sa description, et le bouton en forme d'entonnoir à droite pour ouvrir le panneau de filtres (statut All/In progress/Upcoming/Completed, et affichage limité à vos campagnes assignées — ce dernier filtre est activé par défaut si des campagnes vous ont été assignées). Chaque carte affiche votre progression au format {done}/{total} et l'échéance si elle existe. Cliquez la carte, ou le bouton Démarrer/Consulter, pour ouvrir la campagne : le bouton affiche Démarrer tant qu'aucun test n'a été terminé, puis Consulter une fois qu'au moins un cas a été soumis. Dans une campagne, chaque cas de test a lui aussi son bouton Démarrer/Consulter ; une fois dessus, cliquez « Voir la spec du test » pour déplier l'objectif, les prérequis, le résultat attendu et les étapes (repliés par défaut), puis le bouton « Saisir le résultat du test » en bas de l'écran pour enregistrer votre résultat.",
    "tests.help.section3Title": "Tests faits",
    "tests.help.section3Body":
      "Retrouvez ici l'historique de vos résultats déjà soumis (réussi, échoué, bloqué, ignoré...). Recherchez un test par son titre ou celui de sa campagne, et cliquez le bouton entonnoir pour filtrer par statut, par campagne, ou pour limiter l'affichage à vos campagnes assignées. Cliquez un résultat pour en voir le détail (commentaire, captures, appareil utilisé).",
    "tests.help.section4Title": "À refaire",
    "tests.help.section4Body":
      "Un administrateur peut vous demander de reprendre un test après examen de votre résultat (avec une note explicative). Cet onglet regroupe ces demandes de reprise. Recherchez ou utilisez le bouton entonnoir pour filtrer par campagne ou limiter l'affichage à vos campagnes assignées. Cliquez une carte pour ouvrir le cas de test et soumettre un nouveau résultat.",
    ...
    "tests.detail.attachments.add": "Ajouter des pièces jointes",
    "tests.detail.attachments.chooseFiles": "Choisir des fichiers",
    "tests.detail.attachments.removeLabel": "Retirer",
    ...
    "tests.executions.detail.backToList": "Retour à la liste",
    ...
    "resourcesMine.createAssessment": "Creer une evaluation",
    "resourcesMine.createExam": "Creer un examen",
    "resourcesMine.editMetadata": "Modifier",
    "resourcesMine.manageContent": "Gerer le contenu",
    "resourcesMine.errors.loadFailed": "Impossible de charger vos ressources.",
    "resourcesMine.statementStatus.PENDING": "Enonce en attente",
    "resourcesMine.statementStatus.APPROVED": "Enonce approuve",
    "resourcesMine.statementStatus.REJECTED": "Enonce rejete",
    "resourcesMine.correctionStatus.PENDING": "Corrige en attente",
    "resourcesMine.correctionStatus.APPROVED": "Corrige approuve",
    "resourcesMine.correctionStatus.REJECTED": "Corrige rejete",

    "resourcesMine.form.createAssessmentTitle": "Creer une evaluation",
    "resourcesMine.form.createExamTitle": "Creer un examen",
    "resourcesMine.form.editTitle": "Modifier la ressource",
    "resourcesMine.form.titleLabel": "Titre",
    "resourcesMine.form.titlePlaceholder": "Ex: Devoir chapitre 3",
    "resourcesMine.form.schoolLabel": "Etablissement",
    "resourcesMine.form.schoolSearchPlaceholder":
      "Rechercher un etablissement...",
    "resourcesMine.form.schoolPlaceholder": "Choisir un etablissement",
    "resourcesMine.form.cycleLabel": "Cycle",
    "resourcesMine.form.cyclePlaceholder": "Choisir un cycle",
    "resourcesMine.form.levelLabel": "Niveau",
    "resourcesMine.form.levelPlaceholder": "Choisir un niveau",
    "resourcesMine.form.trackLabel": "Filiere",
    "resourcesMine.form.trackPlaceholder": "Choisir une filiere",
    "resourcesMine.form.subjectLabel": "Matiere",
    "resourcesMine.form.subjectPlaceholder": "Choisir une matiere",
    "resourcesMine.form.examTypeLabel": "Type",
    "resourcesMine.form.sequenceLabel": "Sequence",
    "resourcesMine.form.yearLabel": "Annee scolaire",
    "resourcesMine.form.save": "Enregistrer",
    "resourcesMine.form.saving": "Enregistrement...",
    "resourcesMine.form.cancel": "Annuler",
    "resourcesMine.form.duplicateConfirmPrompt":
      "Confirmer la creation malgre tout ?",
    "resourcesMine.form.errors.titleRequired": "Le titre est requis.",
    "resourcesMine.form.errors.schoolRequired": "L'etablissement est requis.",
    "resourcesMine.form.errors.levelRequired": "Le niveau est requis.",
    "resourcesMine.form.errors.trackRequired": "La filiere est requise.",
    "resourcesMine.form.errors.subjectRequired": "La matiere est requise.",
    "resourcesMine.form.errors.sequenceRequired": "La sequence est requise.",
    "resourcesMine.form.errors.yearRequired": "L'annee scolaire est requise.",
    "resourcesMine.form.errors.saveFailed":
      "Impossible d'enregistrer la ressource.",

    "resourcesMine.contribution.title": "Contenu de la ressource",
    "resourcesMine.contribution.close": "Fermer",
    "resourcesMine.contribution.statementTitle": "Enonce",
    "resourcesMine.contribution.correctionTitle": "Corrige",
    "resourcesMine.contribution.approvedLabel": "Contenu approuve",
    "resourcesMine.contribution.noApprovedYet":
      "Aucun contenu approuve pour le moment.",
    "resourcesMine.contribution.correctionLocked":
      "Le corrige sera disponible une fois l'enonce approuve.",
    "resourcesMine.contribution.myContributionLabel": "Ma contribution",
    "resourcesMine.contribution.addAttachment": "Ajouter une piece jointe",
    "resourcesMine.contribution.saveDraft": "Enregistrer le brouillon",
    "resourcesMine.contribution.submit": "Soumettre pour validation",
    "resourcesMine.contribution.rejectedReasonLabel": "Motif du rejet :",
    "resourcesMine.contribution.status.DRAFT": "Brouillon",
    "resourcesMine.contribution.status.AWAITING": "En attente de validation",
    "resourcesMine.contribution.status.APPROVED": "Approuve",
    "resourcesMine.contribution.status.REJECTED": "Rejete",
    "resourcesMine.contribution.status.DISCARDED": "Abandonne",
    "resourcesMine.contribution.errors.loadFailed":
      "Impossible de charger le contenu.",
    "resourcesMine.contribution.errors.saveFailed":
      "Impossible d'enregistrer le brouillon.",
    "resourcesMine.contribution.errors.submitFailed":
    ...
    "sidebar.nav.resources": "Ressources",
    ...
    "accueil.resources.title": "Ressources",
    "accueil.resources.eyebrow": "Devoirs et examens",
    "accueil.resources.assessments.title": "Devoirs",
    "accueil.resources.exams.title": "Examens",
    "accueil.resources.kpi.withoutStatement": "Sans enonce",
    "accueil.resources.kpi.withoutCorrection": "Sans corrige",
    "accueil.resources.kpi.statementsToApprove": "Enonces a approuver",
    "accueil.resources.kpi.correctionsToApprove": "Corriges a approuver",
    ...
    "onboardingTour.tests.step1Body":
      "« Campagnes » liste les tests à réaliser, « Tests réalisés » garde l'historique de vos résultats, et « À refaire » regroupe les tests qu'un administrateur vous demande de reprendre.",
    "onboardingTour.tests.step3Title": "Une aide toujours disponible",
    "onboardingTour.tests.step3Body":
      "Cliquez ce bouton à tout moment, puis « Aide » dans le menu, pour retrouver ce rappel sur l'utilisation du module.",
    ...
    "documents.placeholder.subtitle": "Module en cours de developpement",
    "documents.placeholder.body":
      "Cette fonctionnalite sera disponible prochainement.",
    "dashboard.student.stats.average": "Moyenne",
    "dashboard.student.stats.subjects": "Matieres",
    "dashboard.student.stats.homework": "Devoirs",
    "dashboard.student.todayTitle": "Cours du jour",
    "dashboard.student.todayEyebrow": "Emploi du temps",
    "dashboard.student.todayEmpty":
      "Aucun cours aujourd'hui. Profitez de votre journee !",
    "dashboard.student.gradesTitle": "Dernieres notes",
    "dashboard.student.gradesEyebrow": "Notes",
    "dashboard.student.gradesEmpty":
      "Vos dernieres evaluations publiees apparaitront ici.",
    ...
    "schools.tab.overview": "Synthese",
    "schools.tab.list": "Liste des ecoles",
    "schools.tab.create": "Creer une ecole",
    "schools.tab.details": "Details",
    "schools.tab.help": "Aide",
    "schools.overview.title": "Vue d'ensemble",
    "schools.overview.totalSchools": "Ecoles",
    "schools.overview.totalStudents": "Eleves",
    "schools.overview.totalClasses": "Classes",
    "schools.overview.byCycleTitle": "Repartition par cycle",
    "schools.overview.schoolsLabel": "ecoles",
    "schools.overview.studentsLabel": "eleves",
    "schools.overview.classesLabel": "classes",
    "schools.overview.cycleUnset": "Non classees",
    "schools.overview.empty": "Aucune ecole a synthetiser pour le moment.",
    "schools.action.newSchool": "Nouvelle ecole",
    "schools.action.view": "Voir",
    ...
    "schools.table.academicYear": "Annee en cours",
    "schools.table.noAcademicYear": "Aucune annee active",
    ...
    "schools.details.schoolSystemTitle": "Systeme scolaire",
    "schools.details.schoolSystemViewFull": "Voir le catalogue complet",
    "schools.details.schoolSystemEmpty":
      "Aucune filiere ni curriculum configure pour cette ecole.",
    "schools.details.schoolSystemTracksTitle": "Filieres",
    "schools.details.schoolSystemNoTracks": "Aucune filiere",
    "schools.details.schoolSystemCurriculumsTitle": "Curriculums",
    "schools.details.schoolSystemNoCurriculums": "Aucun curriculum",
    "schools.details.usersCurrentYearTitle": "Utilisateurs (annee en cours)",
    "schools.details.roleStaff": "Staff",
    "schools.details.roleTeachers": "Enseignants",
    "schools.details.roleParents": "Parents",
    "schools.details.roleStudents": "Eleves",
    ...
    "schools.details.pendingActivation": "activation en attente",
    "schools.details.removeAdmin": "Retirer",
    "schools.details.removeAdminLastAdminHint":
      "Impossible de retirer le dernier administrateur.",
    "schools.details.confirmRemoveAdminTitle": "Retirer l administrateur",
    "schools.details.confirmRemoveAdminMessage":
      "{name} perdra son acces d administrateur a cette ecole.",
    "schools.details.confirmRemoveAdminConfirm": "Retirer",
    ...
    "schools.search.toggleLabel": "Rechercher",
    "schools.search.placeholder": "Nom, slug, ville, region, pays...",
    "schools.search.reset": "Reinitialiser",
    "schools.search.empty": "Aucune ecole ne correspond a la recherche.",
    "schools.form.addAdminTitle": "Ajouter un school admin",
    "schools.form.addAdminEmailLabel": "Email du school admin",
    "schools.form.addAdminSubmit": "Ajouter",
    "schools.form.addAdminSubmitting": "Ajout...",
    "schools.form.addAdminSuccess": "School admin ajoute.",
    "schools.form.addAdminFailed": "Ajout du school admin impossible.",
    "schools.form.adminModeEmail": "Email",
    "schools.form.adminModePhone": "Telephone + PIN",
    "schools.form.fieldAdminPhone": "Telephone",
    "schools.form.fieldAdminPin": "PIN initial",
    "schools.form.mainAdminTitle": "Administrateur principal",
    "schools.form.additionalAdminsTitle": "Administrateurs supplementaires",
    "schools.form.additionalAdminTitle": "Administrateur",
    "schools.form.addAdminButton": "+ Ajouter un administrateur",
    "schools.form.removeAdmin": "Retirer",
    "schools.form.activationCodeBanner":
      "Code d activation a transmettre a l administrateur",
    "schools.form.additionalAdminsFailed":
      "Certains administrateurs supplementaires n ont pas pu etre ajoutes.",
    "schools.form.regionPlaceholder": "Choisir une region",
    "schools.form.cityPlaceholder": "Choisir une ville",
    "schools.form.cityPlaceholderNoRegion": "Choisir une region d abord",
    ...
    "salles.search.placeholder": "Rechercher une salle",
    "salles.filters.toggle": "Filtres",
    "salles.filters.allOption": "Tous",
    "salles.filters.statusLabel": "Statut",
    "salles.filters.simultaneityLabel": "Simultaneite",
    "salles.filters.simultaneity.SINGLE": "Simple (1 creneau)",
    "salles.filters.simultaneity.MULTIPLE": "Multiple (>1 creneau)",
    "salles.filters.availabilityFromLabel": "Disponibilite - Du",
    "salles.filters.availabilityToLabel": "Disponibilite - Au",
    "salles.filters.availabilityStartLabel": "De (heure)",
    "salles.filters.availabilityEndLabel": "A (heure)",
    "salles.filters.reset": "Reinitialiser",
    "salles.filters.apply": "Appliquer",
    "salles.list.colDetail": "Detail",
    "salles.list.viewDetail": "Voir",
    "salles.detail.headerTitle": "Detail de la salle",
    "salles.detail.infoTitle": "Informations",
    "salles.detail.capacityLabel": "Capacite",
    "salles.detail.maxConcurrentSlotsLabel": "Creneaux simultanes max.",
    "salles.detail.statusLabel": "Statut",
    "salles.detail.descriptionLabel": "Description",
    "salles.detail.noDescription": "Aucune description",
    "salles.detail.agendaTitle": "Agenda d'occupation",
    "salles.detail.viewWeek": "Semaine",
    "salles.detail.viewMonth": "Mois",
    "salles.detail.back": "Retour aux salles",
    "salles.detail.notFound": "Salle introuvable.",
    ...
    "classes.tab.students": "Eleves",
    "classes.tab.assignments": "Affectations",
    "classes.tab.help": "Aide",
    "classes.students.hero.noReferent": "Aucun enseignant referent",
    "classes.students.hero.studentsSuffix": "eleves",
    ...
    "classes.list.searchLabel": "Rechercher une classe",
    "classes.list.searchPlaceholder": "Rechercher une classe...",
    "classes.list.allLevels": "Tous",
    "classes.list.noLevel": "Sans niveau",
    ...
    "curriculums.tab.cycles": "Cycles",
    "curriculums.tab.nationalTracks": "Filieres nationales",
    "curriculums.tab.nationalSubjects": "Matieres nationales",
    ...
    "curriculums.national.colTrack": "Filiere",
    ...
    "curriculums.national.codeEditAria": "Code niveau national",
    "curriculums.national.labelEditAria": "Libelle niveau national",
    "curriculums.national.academicLevelEditAria":
      "Niveau academique du curriculum national",
    "curriculums.national.trackLabel": "Filiere (optionnel)",
    "curriculums.national.trackPlaceholder": "Tronc commun",
    "curriculums.national.track.title": "Filieres nationales",
    "curriculums.national.track.codeEditAria": "Code (modification)",
    "curriculums.national.track.labelEditAria": "Libelle (modification)",
    "curriculums.national.track.creating": "Creation...",
    "curriculums.national.track.empty": "Aucune filiere nationale.",
    "curriculums.national.subject.title": "Matieres nationales",
    "curriculums.national.subject.codeLabel": "Code",
    "curriculums.national.subject.codeEditAria": "Code (modification)",
    "curriculums.national.subject.nameLabel": "Nom",
    "curriculums.national.subject.nameEditAria": "Nom (modification)",
    "curriculums.national.subject.creating": "Creation...",
    "curriculums.national.subject.empty": "Aucune matiere nationale.",
    "curriculums.national.subject.rattachementTitle":
      "Rattachement a un curriculum national",
    "curriculums.cycles.unclassified": "Non classe",
    "curriculums.cycles.levelsCount": "niveaux nationaux",
    "curriculums.cycles.unclassifiedLanguage": "Systeme non renseigne",
    ...
    "curriculums.language.filterLabel": "Filtrer par langue",
    "curriculums.language.filterAll": "Toutes les langues",
    "curriculums.language.colLanguage": "Langue",
    "curriculums.language.unspecified": "Non renseignee",
    ...
    "curriculums.subject.colOrigin": "Origine",
    "curriculums.subject.originNational": "National",
    "curriculums.subject.originNationalCustomized": "National (personnalise)",
    "curriculums.subject.originSchool": "Ajoutee par l'ecole",
    ...
    "curriculums.error.curriculumUpdateFailed":
      "Mise a jour curriculum impossible.",
    "curriculums.error.subjectCreateFailed": "Creation matiere impossible.",
    "curriculums.error.subjectUpdateFailed": "Mise a jour matiere impossible.",
    "curriculums.error.subjectDeleteFailed": "Suppression matiere impossible.",
    ...
    "curriculums.success.curriculumEdited": "Curriculum modifie.",
    "curriculums.success.curriculumDeleted": "Curriculum supprime.",
    "curriculums.success.subjectCreated": "Matiere nationale creee.",
    "curriculums.success.subjectEdited": "Matiere nationale modifiee.",
    "curriculums.success.subjectDeleted": "Matiere nationale supprimee.",
    ...
    "users.filter.healthOfficer": "Responsable santé",
    ...
    "users.roles.healthOfficer": "Responsable santé",
    ...
    "users.assignParent.newSubmit": "Créer et associer le parent",
    "users.promote.title": "Créer un accès",
    "users.promote.subtitle": "Création d'un identifiant pour",
    "users.promote.usernameLabel": "Identifiant",
    "users.promote.usernameHint":
      "Un mot de passe temporaire sera généré automatiquement. L'élève devra le changer à la première connexion.",
    "users.promote.suggestLoading": "Génération de l'identifiant unique…",
    "users.promote.submit": "Créer l'accès",
    ...
    "users.create.field.dateOfBirth": "Date de naissance",
    "users.create.field.accessSection": "Accès",
    "users.create.field.accessHint":
      "L'élève est créé sans compte. Le compte (identifiant et mot de passe) se crée ensuite via \"Créer l'accès\" sur sa fiche.",
    ...
    "health.common.networkError": "Erreur réseau, veuillez réessayer.",
    ...
    "health.conditions.inactive": "inactif",
    ...
    "health.history.kindCondition": "Information",
    "health.history.kindCare": "Soin",
    "health.history.kindReport": "Événement",
    ...
    "health.success.conditionCreated": "Information de santé enregistrée.",
    "health.success.reportCreated":
      "Événement signalé, l'enseignant référent sera informé.",
    ...
    "onboardingTour.healthSchool.studentFabBody":
      "Ouvrez la fiche d'un élève pour voir ses soins et conditions de santé, et utilisez le bouton d'ajout pour enregistrer un nouveau soin.",
    "health.school.searchSubtitle":
      "Rechercher un élève pour consulter ou enregistrer une information de santé.",
    ...
    "health.success.careEventCreated":
      "Soin enregistré, le parent a été notifié.",
    ...
    "health.admin.cares.searchPlaceholder": "Rechercher un élève…",
    ...
    "health.admin.cares.empty": "Aucun signalement.",
    "health.admin.cares.pending": "En attente",
    "health.admin.cares.acknowledged": "Acquitté",
    ...
    "health.admin.eleves.searchPlaceholder": "Rechercher un élève…",
    "health.admin.eleves.filters.classLabel": "Classe",
    "health.admin.eleves.filters.allClasses": "Toutes",
    "health.admin.eleves.empty": "Aucun élève.",
    "health.admin.eleves.ageUnit": "ans",
    "health.admin.eleves.noClass": "Sans classe",
    "health.admin.profile.tabs.cares": "Historique",
    "health.admin.profile.tabs.conditions": "Conditions",
    "health.admin.profile.noClass": "Sans classe",
    "health.admin.profile.ageUnknown": "Âge inconnu",
    "health.admin.profile.addCare": "Ajouter un soin",
    "health.admin.profile.editCare": "Modifier",
    "health.admin.profile.form.createTitle": "Ajouter un soin",
    "health.admin.profile.form.editTitle": "Modifier le soin",
  ...
  en: {
    ...
    "header.role.schoolStaff": "Staff",
    "header.role.schoolHealthOfficer": "Health officer",
    ...
    "tests.help.section1Body":
      'This tab gives an overview: number of campaigns, campaigns in progress/upcoming/completed, total test cases and remaining tests. The "To do today" card highlights the most urgent campaign (nearest due date) you still have to finish, with a button to start it directly. Clicking a stat card (Campaigns, In progress, etc.) opens the Campaigns tab filtered on that status.',
    "tests.help.section2Title": "Campaigns",
    "tests.help.section2Body":
      'A campaign groups several test cases to run. Use the search bar to find a campaign by its title or description, and the funnel-shaped button on the right to open the filter panel (status All/In progress/Upcoming/Completed, and restricting the list to campaigns assigned to you — this filter is on by default when you have assigned campaigns). Each card shows your progress as {done}/{total} and the due date if any. Click the card, or the Start/Review button, to open the campaign: the button reads Start until you have completed at least one case, then Review once you have submitted at least one result. Inside a campaign, each test case also has its own Start/Review button; once inside, click "View test spec" to expand the objective, preconditions, expected result and steps (collapsed by default), then the "Enter the test result" button at the bottom of the screen to record your result.',
    "tests.help.section3Title": "Tests done",
    "tests.help.section3Body":
      "Find here the history of results you already submitted (passed, failed, blocked, skipped...). Search a test by its title or its campaign's title, and click the funnel button to filter by status, by campaign, or to restrict the list to campaigns assigned to you. Click a result to see its detail (comment, screenshots, device used).",
    "tests.help.section4Title": "To redo",
    "tests.help.section4Body":
      "An administrator may ask you to redo a test after reviewing your result (with an explanatory note). This tab gathers these rework requests. Search or use the funnel button to filter by campaign or restrict the list to campaigns assigned to you. Click a card to open the test case and submit a new result.",
    ...
    "tests.detail.attachments.add": "Add attachments",
    "tests.detail.attachments.chooseFiles": "Choose files",
    "tests.detail.attachments.removeLabel": "Remove",
    ...
    "tests.executions.detail.backToList": "Back to list",
    ...
    "resourcesMine.createAssessment": "Create an assessment",
    "resourcesMine.createExam": "Create an exam",
    "resourcesMine.editMetadata": "Edit",
    "resourcesMine.manageContent": "Manage content",
    "resourcesMine.errors.loadFailed": "Could not load your resources.",
    "resourcesMine.statementStatus.PENDING": "Statement pending",
    "resourcesMine.statementStatus.APPROVED": "Statement approved",
    "resourcesMine.statementStatus.REJECTED": "Statement rejected",
    "resourcesMine.correctionStatus.PENDING": "Correction pending",
    "resourcesMine.correctionStatus.APPROVED": "Correction approved",
    "resourcesMine.correctionStatus.REJECTED": "Correction rejected",

    "resourcesMine.form.createAssessmentTitle": "Create an assessment",
    "resourcesMine.form.createExamTitle": "Create an exam",
    "resourcesMine.form.editTitle": "Edit resource",
    "resourcesMine.form.titleLabel": "Title",
    "resourcesMine.form.titlePlaceholder": "E.g. Chapter 3 homework",
    "resourcesMine.form.schoolLabel": "School",
    "resourcesMine.form.schoolSearchPlaceholder": "Search a school...",
    "resourcesMine.form.schoolPlaceholder": "Choose a school",
    "resourcesMine.form.cycleLabel": "Cycle",
    "resourcesMine.form.cyclePlaceholder": "Choose a cycle",
    "resourcesMine.form.levelLabel": "Level",
    "resourcesMine.form.levelPlaceholder": "Choose a level",
    "resourcesMine.form.trackLabel": "Track",
    "resourcesMine.form.trackPlaceholder": "Choose a track",
    "resourcesMine.form.subjectLabel": "Subject",
    "resourcesMine.form.subjectPlaceholder": "Choose a subject",
    "resourcesMine.form.examTypeLabel": "Type",
    "resourcesMine.form.sequenceLabel": "Sequence",
    "resourcesMine.form.yearLabel": "Academic year",
    "resourcesMine.form.save": "Save",
    "resourcesMine.form.saving": "Saving...",
    "resourcesMine.form.cancel": "Cancel",
    "resourcesMine.form.duplicateConfirmPrompt": "Confirm creation anyway?",
    "resourcesMine.form.errors.titleRequired": "Title is required.",
    "resourcesMine.form.errors.schoolRequired": "School is required.",
    "resourcesMine.form.errors.levelRequired": "Level is required.",
    "resourcesMine.form.errors.trackRequired": "Track is required.",
    "resourcesMine.form.errors.subjectRequired": "Subject is required.",
    "resourcesMine.form.errors.sequenceRequired": "Sequence is required.",
    "resourcesMine.form.errors.yearRequired": "Academic year is required.",
    "resourcesMine.form.errors.saveFailed": "Could not save the resource.",

    "resourcesMine.contribution.title": "Resource content",
    "resourcesMine.contribution.close": "Close",
    "resourcesMine.contribution.statementTitle": "Statement",
    "resourcesMine.contribution.correctionTitle": "Correction",
    "resourcesMine.contribution.approvedLabel": "Approved content",
    "resourcesMine.contribution.noApprovedYet": "No approved content yet.",
    "resourcesMine.contribution.correctionLocked":
      "The correction will be available once the statement is approved.",
    "resourcesMine.contribution.myContributionLabel": "My contribution",
    "resourcesMine.contribution.addAttachment": "Add an attachment",
    "resourcesMine.contribution.saveDraft": "Save draft",
    "resourcesMine.contribution.submit": "Submit for review",
    "resourcesMine.contribution.rejectedReasonLabel": "Rejection reason:",
    "resourcesMine.contribution.status.DRAFT": "Draft",
    "resourcesMine.contribution.status.AWAITING": "Awaiting review",
    "resourcesMine.contribution.status.APPROVED": "Approved",
    "resourcesMine.contribution.status.REJECTED": "Rejected",
    "resourcesMine.contribution.status.DISCARDED": "Discarded",
    "resourcesMine.contribution.errors.loadFailed":
      "Could not load the content.",
    "resourcesMine.contribution.errors.saveFailed": "Could not save the draft.",
    "resourcesMine.contribution.errors.submitFailed":
    ...
    "accueil.resources.title": "Resources",
    "accueil.resources.eyebrow": "Assessments and exams",
    "accueil.resources.assessments.title": "Assessments",
    "accueil.resources.exams.title": "Exams",
    "accueil.resources.kpi.withoutStatement": "Missing statement",
    "accueil.resources.kpi.withoutCorrection": "Missing correction",
    "accueil.resources.kpi.statementsToApprove": "Statements to approve",
    "accueil.resources.kpi.correctionsToApprove": "Corrections to approve",
    ...
    "onboardingTour.tests.step3Body":
      'Click this button at any time, then "Help" in the menu, to see this reminder about the module again.',
    ...
    "documents.placeholder.subtitle": "Module under development",
    "documents.placeholder.body": "This feature will be available soon.",
    "dashboard.student.stats.average": "Average",
    "dashboard.student.stats.subjects": "Subjects",
    "dashboard.student.stats.homework": "Homework",
    "dashboard.student.todayTitle": "Today's classes",
    "dashboard.student.todayEyebrow": "Timetable",
    "dashboard.student.todayEmpty": "No classes today. Enjoy your day!",
    "dashboard.student.gradesTitle": "Latest grades",
    "dashboard.student.gradesEyebrow": "Grades",
    "dashboard.student.gradesEmpty":
      "Your latest published assessments will appear here.",
    ...
    "schools.tab.overview": "Overview",
    "schools.tab.list": "School list",
    "schools.tab.create": "Create school",
    "schools.tab.details": "Details",
    "schools.tab.help": "Help",
    "schools.overview.title": "Overview",
    "schools.overview.totalSchools": "Schools",
    "schools.overview.totalStudents": "Students",
    "schools.overview.totalClasses": "Classes",
    "schools.overview.byCycleTitle": "Breakdown by cycle",
    "schools.overview.schoolsLabel": "schools",
    "schools.overview.studentsLabel": "students",
    "schools.overview.classesLabel": "classes",
    "schools.overview.cycleUnset": "Unclassified",
    "schools.overview.empty": "Nothing to summarize yet.",
    "schools.action.newSchool": "New school",
    "schools.action.view": "View",
    ...
    "schools.table.academicYear": "Current year",
    "schools.table.noAcademicYear": "No active year",
    ...
    "schools.details.schoolSystemTitle": "School system",
    "schools.details.schoolSystemViewFull": "View full catalog",
    "schools.details.schoolSystemEmpty":
      "No track or curriculum configured for this school.",
    "schools.details.schoolSystemTracksTitle": "Tracks",
    "schools.details.schoolSystemNoTracks": "No track",
    "schools.details.schoolSystemCurriculumsTitle": "Curriculums",
    "schools.details.schoolSystemNoCurriculums": "No curriculum",
    "schools.details.usersCurrentYearTitle": "Users (current year)",
    "schools.details.roleStaff": "Staff",
    "schools.details.roleTeachers": "Teachers",
    "schools.details.roleParents": "Parents",
    "schools.details.roleStudents": "Students",
    ...
    "schools.details.pendingActivation": "activation pending",
    "schools.details.removeAdmin": "Remove",
    "schools.details.removeAdminLastAdminHint":
      "The last administrator cannot be removed.",
    "schools.details.confirmRemoveAdminTitle": "Remove administrator",
    "schools.details.confirmRemoveAdminMessage":
      "{name} will lose administrator access to this school.",
    "schools.details.confirmRemoveAdminConfirm": "Remove",
    ...
    "schools.search.toggleLabel": "Search",
    "schools.search.placeholder": "Name, slug, city, region, country...",
    "schools.search.reset": "Reset",
    "schools.search.empty": "No school matches the search.",
    "schools.form.addAdminTitle": "Add a school admin",
    "schools.form.addAdminEmailLabel": "School admin email",
    "schools.form.addAdminSubmit": "Add",
    "schools.form.addAdminSubmitting": "Adding...",
    "schools.form.addAdminSuccess": "School admin added.",
    "schools.form.addAdminFailed": "Failed to add school admin.",
    "schools.form.adminModeEmail": "Email",
    "schools.form.adminModePhone": "Phone + PIN",
    "schools.form.fieldAdminPhone": "Phone",
    "schools.form.fieldAdminPin": "Initial PIN",
    "schools.form.mainAdminTitle": "Main administrator",
    "schools.form.additionalAdminsTitle": "Additional administrators",
    "schools.form.additionalAdminTitle": "Administrator",
    "schools.form.addAdminButton": "+ Add an administrator",
    "schools.form.removeAdmin": "Remove",
    "schools.form.activationCodeBanner":
      "Activation code to share with the administrator",
    "schools.form.additionalAdminsFailed":
      "Some additional administrators could not be added.",
    "schools.form.regionPlaceholder": "Choose a region",
    "schools.form.cityPlaceholder": "Choose a city",
    "schools.form.cityPlaceholderNoRegion": "Choose a region first",
    ...
    "salles.search.placeholder": "Search for a room",
    "salles.filters.toggle": "Filters",
    "salles.filters.allOption": "All",
    "salles.filters.statusLabel": "Status",
    "salles.filters.simultaneityLabel": "Simultaneity",
    "salles.filters.simultaneity.SINGLE": "Single (1 slot)",
    "salles.filters.simultaneity.MULTIPLE": "Multiple (>1 slot)",
    "salles.filters.availabilityFromLabel": "Availability - From",
    "salles.filters.availabilityToLabel": "Availability - To",
    "salles.filters.availabilityStartLabel": "From (time)",
    "salles.filters.availabilityEndLabel": "To (time)",
    "salles.filters.reset": "Reset",
    "salles.filters.apply": "Apply",
    "salles.list.colDetail": "Detail",
    "salles.list.viewDetail": "View",
    "salles.detail.headerTitle": "Room detail",
    "salles.detail.infoTitle": "Information",
    "salles.detail.capacityLabel": "Capacity",
    "salles.detail.maxConcurrentSlotsLabel": "Max. simultaneous slots",
    "salles.detail.statusLabel": "Status",
    "salles.detail.descriptionLabel": "Description",
    "salles.detail.noDescription": "No description",
    "salles.detail.agendaTitle": "Occupancy agenda",
    "salles.detail.viewWeek": "Week",
    "salles.detail.viewMonth": "Month",
    "salles.detail.back": "Back to rooms",
    "salles.detail.notFound": "Room not found.",
    ...
    "classes.tab.students": "Students",
    "classes.tab.assignments": "Assignments",
    "classes.tab.help": "Help",
    "classes.students.hero.noReferent": "No referent teacher",
    "classes.students.hero.studentsSuffix": "students",
    ...
    "classes.list.searchLabel": "Search a class",
    "classes.list.searchPlaceholder": "Search a class...",
    "classes.list.allLevels": "All",
    "classes.list.noLevel": "No level",
    ...
    "curriculums.tab.cycles": "Cycles",
    "curriculums.tab.nationalTracks": "National tracks",
    "curriculums.tab.nationalSubjects": "National subjects",
    ...
    "curriculums.national.colTrack": "Track",
    "curriculums.national.colActions": "Actions",
    "curriculums.national.codeEditAria": "National level code",
    "curriculums.national.labelEditAria": "National level label",
    "curriculums.national.academicLevelEditAria":
      "National curriculum academic level",
    "curriculums.national.trackLabel": "Track (optional)",
    "curriculums.national.trackPlaceholder": "Common core",
    "curriculums.national.track.title": "National tracks",
    "curriculums.national.track.codeEditAria": "Code (edit)",
    "curriculums.national.track.labelEditAria": "Label (edit)",
    "curriculums.national.track.creating": "Creating...",
    "curriculums.national.track.empty": "No national track.",
    "curriculums.national.subject.title": "National subjects",
    "curriculums.national.subject.codeLabel": "Code",
    "curriculums.national.subject.codeEditAria": "Code (edit)",
    "curriculums.national.subject.nameLabel": "Name",
    "curriculums.national.subject.nameEditAria": "Name (edit)",
    "curriculums.national.subject.creating": "Creating...",
    "curriculums.national.subject.empty": "No national subject.",
    "curriculums.national.subject.rattachementTitle":
      "Attach to a national curriculum",
    "curriculums.cycles.unclassified": "Unclassified",
    "curriculums.cycles.levelsCount": "national levels",
    "curriculums.cycles.unclassifiedLanguage": "System not set",
    ...
    "curriculums.language.filterLabel": "Filter by language",
    "curriculums.language.filterAll": "All languages",
    "curriculums.language.colLanguage": "Language",
    "curriculums.language.unspecified": "Unspecified",
    "curriculums.level.codeLabel": "Code",
    ...
    "curriculums.subject.colOrigin": "Origin",
    "curriculums.subject.originNational": "National",
    "curriculums.subject.originNationalCustomized": "National (customized)",
    "curriculums.subject.originSchool": "Added by school",
    "curriculums.subject.colAction": "Action",
    ...
    "curriculums.error.curriculumUpdateFailed": "Failed to update curriculum.",
    "curriculums.error.subjectCreateFailed": "Failed to create subject.",
    "curriculums.error.subjectUpdateFailed": "Failed to update subject.",
    "curriculums.error.subjectDeleteFailed": "Failed to delete subject.",
    ...
    "curriculums.success.curriculumEdited": "Curriculum updated.",
    "curriculums.success.curriculumDeleted": "Curriculum deleted.",
    "curriculums.success.subjectCreated": "National subject created.",
    "curriculums.success.subjectEdited": "National subject updated.",
    "curriculums.success.subjectDeleted": "National subject deleted.",
    ...
    "users.filter.healthOfficer": "Health officer",
    ...
    "users.roles.healthOfficer": "Health officer",
    ...
    "users.assignParent.newSubmit": "Create and link the parent",
    "users.promote.title": "Create access",
    "users.promote.subtitle": "Creating a username for",
    "users.promote.usernameLabel": "Username",
    "users.promote.usernameHint":
      "A temporary password will be generated automatically. The student will have to change it on first sign-in.",
    "users.promote.suggestLoading": "Generating a unique username…",
    "users.promote.submit": "Create access",
    ...
    "users.create.field.dateOfBirth": "Date of birth",
    "users.create.field.accessSection": "Access",
    "users.create.field.accessHint":
    ...
    "health.common.networkError": "Network error, please try again.",
    "health.parent.tabs.conditions": "Conditions",
    ...
    "health.conditions.inactive": "inactive",
    ...
    "health.history.kindCondition": "Information",
    "health.history.kindCare": "Care",
    "health.history.kindReport": "Event",
    "health.form.conditionType": "Type",
    ...
    "health.success.conditionCreated": "Health information saved.",
    "health.success.reportCreated":
      "Event reported, the class teacher will be notified.",
    "health.alertLevel.INFO": "Information",
    "health.alertLevel.ATTENTION": "Attention",
    "health.alertLevel.URGENT": "Urgent",
    ...
    "onboardingTour.healthSchool.studentFabBody":
      "Open a student's profile to see their cares and health conditions, and use the add button to record a new care.",
    "health.school.searchSubtitle":
      "Search a student to view or record health information.",
    ...
    "health.success.careEventCreated":
      "Care recorded, the parent has been notified.",
    ...
    "health.admin.cares.searchPlaceholder": "Search a student…",
    ...
    "health.admin.cares.empty": "No report.",
    "health.admin.cares.pending": "Pending",
    "health.admin.cares.acknowledged": "Acknowledged",
    "health.admin.cares.card.acknowledgeAction": "Mark as acknowledged",
    "health.admin.cares.card.acknowledging": "Saving…",
    "health.admin.eleves.searchPlaceholder": "Search a student…",
    "health.admin.eleves.filters.classLabel": "Class",
    "health.admin.eleves.filters.allClasses": "All",
    "health.admin.eleves.empty": "No student.",
    "health.admin.eleves.ageUnit": "yo",
    "health.admin.eleves.noClass": "No class",
    "health.admin.profile.tabs.cares": "History",
    "health.admin.profile.tabs.conditions": "Conditions",
    "health.admin.profile.noClass": "No class",
    "health.admin.profile.ageUnknown": "Age unknown",
    "health.admin.profile.addCare": "Add a care",
    "health.admin.profile.editCare": "Edit",
    "health.admin.profile.form.createTitle": "Add a care",
    "health.admin.profile.form.editTitle": "Edit the care",
