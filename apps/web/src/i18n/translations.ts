...
export const translations: Record<Locale, Record<string, string>> = {
  fr: {
    ...
    "onboardingTour.healthParent.conditionFormBody":
      "Indiquez une allergie, une pathologie ou une instruction particulière. Le niveau (Information / Attention / Urgent) détermine sa visibilité pour l'équipe pédagogique.",
    "onboardingTour.healthParent.reportFormTitle":
      "Signaler un événement hors école",
    "onboardingTour.healthParent.reportFormBody":
      "Maladie, accident, traitement... l'enseignant référent de la classe est automatiquement informé. Cochez la case si une restriction sportive doit être appliquée.",
  ...
  en: {
    ...
    "onboardingTour.healthParent.conditionFormBody":
      "Record an allergy, a pathology, or a special instruction. The level (Information / Attention / Urgent) sets its visibility to the teaching team.",
    "onboardingTour.healthParent.reportFormTitle":
      "Report an event outside school",
    "onboardingTour.healthParent.reportFormBody":
      "Illness, accident, treatment... the class referent teacher is automatically notified. Check the box if a sport restriction applies.",
