...
const QUESTIONS = [
  ...
  },
  {
    ...
    deepLinkRoute: "/children/{childId}/cahier-de-texte",
    textFr:
      'Le module Devoirs propose deux onglets. À quoi sert l\'onglet "Liste" ?',
    textEn: 'The Homework module has two tabs. What is the "List" tab for?',
    hintFr:
      "C'est l'onglet ouvert par défaut quand vous arrivez sur le module.",
  ...
  },
  {
    ...
    deepLinkRoute: "/children/{childId}/cahier-de-texte",
    textFr:
      "Dans l'onglet Liste, les devoirs sont triés par échéance la plus proche en premier.",
    textEn:
      "In the List tab, homework items are sorted with the closest deadline first.",
    hintFr: "Pensez à l'ordre le plus utile pour ne rien oublier.",
    hintEn:
      "Think about the order that is most useful so nothing gets forgotten.",
    explanationFr:
  ...
  },
  {
    ...
    hintFr:
      "Un statut pour ce qui reste à faire, un pour ce qui est fait, un pour ce qui a dépassé la date.",
    hintEn:
      "One status for what's left to do, one for what's done, one for what's past due.",
    explanationFr:
  ...
  },
  {
    ...
    deepLinkRoute: "/children/{childId}/cahier-de-texte",
    textFr:
      "Cliquer sur un devoir de la liste ouvre la consigne complète et les pièces jointes.",
    textEn:
      "Clicking a homework item in the list opens the full instructions and attachments.",
    hintFr:
      "La ligne de liste n'est qu'un résumé : titre, matière, échéance, statut.",
  ...
  },
  {
    ...
    deepLinkRoute: "/children/{childId}/cahier-de-texte",
    textFr:
      "Quels éléments retrouve-t-on dans le détail d'un devoir ? (plusieurs réponses)",
    textEn:
      "Which elements do you find in a homework item's detail? (multiple answers)",
    hintFr:
      "Pensez à ce qu'un enseignant peut donner comme consigne et fournir comme document.",
    hintEn:
      "Think about what a teacher can give as instructions and provide as documents.",
    explanationFr:
  ...
  },
  {
    ...
    deepLinkRoute: "/children/{childId}/cahier-de-texte",
    textFr:
      'Dans la liste, quelle information est affichée avec le préfixe "Pour le" ?',
  ...
  },
  {
    ...
    hintFr:
      'Ouvrez l\'onglet "Voir" et lisez le chiffre associé à "En retard".',
    ...
    options: [
      {
        textFr:
          'Le chiffre affiché dans l\'onglet "Voir" en face de "En retard"',
  ...
  },
  {
    ...
    textEn:
      'Open the "List" tab: what subject is the very first homework item shown?',
    hintFr:
      "Le premier de la liste est celui dont l'échéance est la plus proche.",
  ...
  },
  {
    ...
    options: [
      {
        textFr:
          'Le devoir passe "Validé" et le bouton devient "Marquer non fait"',
        textEn:
          'The homework becomes "Validated" and the button becomes "Mark not done"',
        isCorrect: true,
      },
      {
  ...
  },
  {
    ...
    deepLinkRoute: "/children/{childId}/cahier-de-texte",
    textFr:
      'Vous pouvez annuler un "Marquer fait" en cliquant à nouveau sur le bouton.',
  ...
  },
  {
    ...
    deepLinkRoute: "/children/{childId}/cahier-de-texte",
    textFr:
      "Comment ajouter un commentaire sur un devoir depuis l'application ?",
    ...
    hintEn:
      "Open the homework's detail and look for the input area at the bottom.",
    explanationFr:
    ...
    options: [
      ...
      {
        textFr:
          "Passer par la messagerie de l'école, ce module n'a pas de commentaires",
        textEn:
          "Go through the school's messaging, this module has no comments",
        isCorrect: false,
      },
      {
  ...
  },
  {
    ...
    deepLinkRoute: "/children/{childId}/cahier-de-texte",
    textFr:
      "Où retrouvez-vous les documents fournis par l'enseignant pour un devoir ?",
    textEn:
      "Where do you find the documents provided by the teacher for a homework item?",
    hintFr:
      "Ouvrez le détail du devoir et cherchez une section dédiée aux fichiers.",
    hintEn:
      "Open the homework's detail and look for a section dedicated to files.",
    explanationFr:
  ...
  },
  {
    ...
    deepLinkRoute: "/children/{childId}/cahier-de-texte",
    textFr:
      "Où trouvez-vous le nombre total de devoirs suivis pour votre enfant ?",
    textEn:
      "Where do you find the total number of homework items tracked for your child?",
  ...
  },
  {
    ...
    deepLinkRoute: "/children/{childId}/cahier-de-texte",
    textFr:
      'Ouvrez l\'onglet "Liste" : quelles colonnes voyez-vous pour chaque devoir ? (plusieurs réponses)',
    textEn:
      'Open the "List" tab: which columns do you see for each homework item? (multiple answers)',
  ...
  },
  {
    ...
    deepLinkRoute: "/children/{childId}/cahier-de-texte",
    textFr:
      "Le nombre de commentaires d'un devoir est visible directement dans la liste, sans ouvrir le détail.",
    textEn:
      "The number of comments on a homework item is visible directly in the list, without opening the detail.",
    hintFr:
      "Regardez attentivement les colonnes de la liste : Titre, Matière, Échéance, Statut.",
    hintEn:
      "Look carefully at the list's columns: Title, Subject, Deadline, Status.",
    explanationFr:
  ...
  },
  {
    ...
    hintFr:
      "Ce n'est pas un menu global : regardez les onglets du module lui-même.",
  ...
  },
  {
    ...
    hintFr:
      'Le statut "Validé" est indépendant de la date une fois le devoir marqué fait.',
    hintEn:
      'The "Validated" status is independent from the date once the homework is marked done.',
    explanationFr:
    ...
    options: [
      ...
      { textFr: "À faire", textEn: "To do", isCorrect: false },
      {
        textFr: "En attente de correction",
  ...
  },
  {
    ...
    deepLinkRoute: "/children/{childId}/cahier-de-texte",
    textFr:
      'Quelle est la différence essentielle entre l\'onglet "Liste" et l\'onglet "Voir" ?',
    textEn:
      'What is the essential difference between the "List" tab and the "View" tab?',
    hintFr: "L'un détaille devoir par devoir, l'autre synthétise en chiffres.",
    hintEn:
      "One details homework item by item, the other summarises with numbers.",
    explanationFr:
    ...
    options: [
      {
        textFr:
          '"Liste" détaille chaque devoir, "Voir" donne une synthèse chiffrée',
  ...
  },
  {
    ...
    deepLinkRoute: "/children/{childId}/cahier-de-texte",
    textFr:
      "En tant que parent, vous pouvez marquer un devoir de votre enfant comme fait.",
    textEn: "As a parent, you can mark your child's homework as done.",
    hintFr:
      'Le bouton "Marquer fait" est disponible dans le détail du devoir, quel que soit le compte connecté (élève ou parent).',
    hintEn:
      'The "Mark done" button is available in the homework detail, whether the connected account is a student or a parent.',
    explanationFr:
  ...
  },
  {
    ...
    deepLinkRoute: "/children/{childId}/cahier-de-texte",
    textFr:
      'Pourquoi consulter régulièrement l\'onglet "Voir" plutôt que la liste complète ?',
    ...
    hintEn:
      "Think about what lets you react quickly without re-reading everything.",
    explanationFr:
    ...
    options: [
      {
        textFr:
          "Pour repérer immédiatement un devoir en retard sans tout relire",
        textEn:
          "To immediately spot a late homework item without re-reading everything",
        isCorrect: true,
      },
      {
  ...
  },
  {
    ...
    deepLinkRoute: "/children/{childId}/cahier-de-texte",
    textFr:
      "Quelles actions un parent peut-il réaliser sur un devoir ? (plusieurs réponses)",
    textEn:
      "Which actions can a parent perform on a homework item? (multiple answers)",
  ...
  },
  {
    ...
    deepLinkRoute: "/children/{childId}/cahier-de-texte",
    textFr:
      "Un parent peut modifier la consigne d'un devoir rédigée par l'enseignant.",
    textEn:
      "A parent can edit a homework's instructions written by the teacher.",
    hintFr:
      "Un parent peut réagir (commentaire, statut) mais pas réécrire le contenu pédagogique.",
    hintEn:
      "A parent can react (comment, status) but not rewrite the teaching content.",
    explanationFr:
  ...
  },
  {
    ...
    deepLinkRoute: "/children/{childId}/cahier-de-texte",
    textFr:
      "Quel est le moyen le plus rapide de savoir qu'un nouveau devoir a été publié depuis votre dernière visite ?",
    textEn:
      "What is the fastest way to know a new homework item was published since your last visit?",
  ...
  },
  {
    ...
    hintFr:
      "L'échéance n'est pas encore dépassée : ce n'est donc pas \"En retard\".",
    ...
    options: [
      ...
      {
        textFr:
          "Aucun compteur, car il a des pièces jointes et des commentaires",
